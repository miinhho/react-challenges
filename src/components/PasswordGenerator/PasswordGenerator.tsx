...
const PasswordGenerator = () => {
  ...
  const togglePasswordSetting = (setting: keyof PasswordSettings, checked: boolean) => {
          ...
          <div className={styles.roundedBlockContainer}>
            <div className={styles.roundedBlock}>
              ...
              <SettingToggle
                ...
                onChange={(checked) => togglePasswordSetting('includeUppercase', checked)}
              />
            </div>
            <div className={styles.roundedBlock}>
              ...
              <SettingToggle
                ...
                onChange={(checked) => togglePasswordSetting('includeLowercase', checked)}
              />
            </div>
            <div className={styles.roundedBlock}>
              <p>Include numbers</p>
              <SettingToggle
                ...
                onChange={(checked) => togglePasswordSetting('includeNumbers', checked)}
              />
            </div>
            <div className={styles.roundedBlock}>
              <p>Include symbols</p>
              <SettingToggle
                ...
                onChange={(checked) => togglePasswordSetting('includeSymbols', checked)}
              />
            </div>
          </div>
        </div>
